...
// Create an SVG wrapper, append an SVG group that will hold our chart and shift left and top margins.
var svg = d3
  .select("#scatter")
  .append("svg")
  .attr("width", svgWidth)
...
// function used for updating texts inside the circles group with a transition to new circles
